...
- Do not reference runtime image URLs using /src/assets/... in JSX or inline CSS.
- For static marketing images in this codebase, place them in public/assets/ and reference them as /assets/<filename>.
